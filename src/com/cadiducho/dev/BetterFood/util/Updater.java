...
/**
 * Gravity's Simple Update Checker This class is a barebones example of how to
 * use the BukkitDev ServerMods API to check for file updates.
 */
public class Updater {
	 ...
	 */
	public Updater(int projectID, String version) {
	 ...
	 */
	public Updater(int projectID, String version, String apiKey) {
		this.projectID = projectID;
		this.currentVersion = version;
		this.apiKey = apiKey;
		query();
	 ...
	 * 
	 * @return (boolean) True if there is an update avaiable, False if the
	 *         plugin is up-to-date or if an exception has been thrown.
	 */
	public boolean query() {
		...
		try {
			...
			if (array.size() > 0) {
				...
				String latestVersion = versionName.replace("BetterFood [", "")
				...
				System.out
						.println("[BetterFood] There are no files for this project");
				return false;
			}
		} catch (IOException e) {
